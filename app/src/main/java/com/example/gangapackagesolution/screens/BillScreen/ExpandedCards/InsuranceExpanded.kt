...
@Composable
fun InsuranceExpanded(
    modifier: Modifier = Modifier,
    billState: BillState
                     ) {
    val data = Data

    val selectedInsuranceType = billState.insuranceType

    val selectedInsuranceCharge = billState.insuranceCharge

    val selectedGstPercentage = billState.insuranceGst
